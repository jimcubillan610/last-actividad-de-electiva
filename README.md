    ...
    <style>
        ...
        * {
        ...
        .fondo {
           ...
           width: 1000px;
            height: auto;
            box-shadow: #212529 0 4px 10px; 
        }

        .cuadro:hover {
box-shadow: #0dfd35 0 5px 10px;
...
<body>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <div id="intro" class="tarjeta-parrafo" class="cuadro">
                <p>
